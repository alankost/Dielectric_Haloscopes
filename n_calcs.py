...
p0 = 5e-4 # thermal occupation factor
N0 = p0*6.022e23*1e3/22.4 # number density in level 0 at T=273 C and P=1 atm
...
if __name__ == '__main__':
    ...
    num_layers = 201  # number of layers in the stack

    boost2 = stacks.hw_boost(omega_wide, omega0, 1.5, complex_n, num_layers, n2_real0=1)
    ...
    boost1 = stacks.hw_boost(omega, omega0, 1.5, complex_n, num_layers, n2_real0=1)
    ...
    # test boost factor as a function of Re(n)
    ntest = np.linspace(0.7, 1.4, 1000)
    boost3 = [stacks.hw_boost(omega0, omega0, 1.5, n_, num_layers, n2_real0=1) for n_ in ntest]
    ...
    # test boost factor as a function of Im(n)
    ntest = 1 + 1j * np.linspace(-2, 2, 100)
    boost4 = [stacks.hw_boost(omega0, omega0, 1.5, n_, num_layers, n2_real0=1) for n_ in ntest]
