...
if __name__ == '__main__':
    ...
    boost3 = [stacks.hw_boost(omega0, omega0, 1.5, n_, A, n2_real0=1) for n_ in ntest]
    ...
    boost4 = [stacks.hw_boost(omega0, omega0, 1.5, n_, A, n2_real0=1) for n_ in ntest]
