...
file = open(os.path.join(this_folder, 'data', 'CO_data_20JAN2022.txt'))
...
file2 = open(os.path.join(this_folder, 'data', 'Partfun_12C16O.txt'))
...
if __name__ == '__main__':
    ...
    Tgas = 100 # Temperature of gas in degress Kelvin
    Pgas = 5 # Pressure of gas in atm (1 atm = 1.01325)
